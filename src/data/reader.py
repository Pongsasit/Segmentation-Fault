...
def prepre_geo_data(config):
    ...
    for im_path in im_paths:
        ...
        # cut to shape
        train = subprocess.Popen(["gdalwarp", "-crop_to_cutline", "-cutline", train_labels_shp_path, 'tmp.tif', 'tmp_train.tif'], stdout=subprocess.PIPE)
        _ = train.communicate()[0]
        ...
        os.remove('tmp_train.tif')
        os.remove('tmp_test.tif')
